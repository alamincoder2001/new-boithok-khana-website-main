...
<head>
    ...
    <link rel="icon" type="image/png" href="http://localhost:82/uploads/company_profile_org/{{ $content->Company_Logo_org }}"/>
    ...
    <script>
        function quickOrder(){
            ...
            $.ajax({
                url: "{{ route('add.cart') }}",
                type:"POST",
                data: { txtId: txtId, quantity: quantity },
